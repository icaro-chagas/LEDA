...
public class StudentQueueTest {
	...
	private void getImplementations() {
		...
		queue4 = new QueueDoubleLinkedListImpl<String>(5);
		queue5 = new QueueDoubleLinkedListImpl<String>(2);
		queue6 = new QueueDoubleLinkedListImpl<String>(6);
		
		queue7 = new QueueDoubleLinkedListImpl<String>(0);
