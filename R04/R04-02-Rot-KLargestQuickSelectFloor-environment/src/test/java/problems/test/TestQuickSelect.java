...
public class TestQuickSelect {
	...
	public void genericTest(Integer[] array, int k) {
		...
		if (k < 1 || k > array.length) {
			...
			System.out.println("quickSelect: " + implementation.quickSelect(array, k) + "\n");*/
			Assert.assertNull(implementation.quickSelect(array, k));
		}
		else {
			Arrays.sort(copy1);
			/*System.out.println("k: " + k);
			...
			Assert.assertEquals(copy1[k-1], implementation.quickSelect(array, k));
		}
	}
